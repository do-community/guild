...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex">
            <div class="container relative z-20 flex-shrink-0 w-full font-sans antialiased text-gray-900 md:max-w-xl">
                {{ $slot }}
            </div>
            <img src="/images/auth-bg.jpg" class="z-10 object-cover w-full h-screen">
